...
Dada la naturaleza técnica de las preguntas y la disponibilidad real de
los stakeholders, se aplicó de forma directa durante las sesiones de
entrevista en lugar de mediante un formulario independiente de Google
Forms. \\
\hline
\end{tabularx}
\end{table}
...
\hline
2 & Aplicación del cuestionario (de forma directa, integrado a la entrevista técnica) & Integrante 2 & 30 min \\
\hline
...
Se realizó una entrevista técnica centrada en identificar los parámetros
...
(presencial y en línea). Se tabuló la información obtenida, donde el 100\,\%
de los participantes confirmó la necesidad del sistema, priorizando el
registro de vacunas y los recordatorios automáticos de citas.
...
\hline
\textbf{Temas tratados}  & \begin{enumerate}[leftmargin=*,topsep=0pt]
                           ...
                           \end{enumerate} \\
\hline
\textbf{Requisitos identificados} & \begin{enumerate}[leftmargin=*,topsep=0pt]
...
\textbf{Número de respondentes:} 3 personas (médicos veterinarios y usuarios
expertos).\\
\textbf{Fecha de aplicación:} 17/05/2026

\textbf{Cuestionario aplicado -- Escala Likert (1: Totalmente en desacuerdo
-- 5: Totalmente de acuerdo):}

\begin{enumerate}[leftmargin=*]
  \item ¿Es necesario un registro digital unificado de mascotas? (5)
  \item ¿El historial de vacunas debe ser de consulta obligatoria? (5)
  \item ¿Las notificaciones automáticas mejorarían el cumplimiento de citas? (4)
  \item ¿Es vital registrar el temperamento/raza para evaluar adopciones? (5)
  \item ¿La geolocalización de clínicas es útil para el usuario? (4)
  \item \textbf{(Abierta)} ¿Qué datos considera más sensibles en el perfil
  médico? \textit{Respuesta:} enfermedades catastróficas, riesgo de muerte y
  cirugías previas.
  \item ¿Los datos de enfermedades catastróficas deben ser privados? (5)
  \item ¿Se debe incluir un sistema de seguimiento para adopciones? (5)
  \item ¿Es necesario registrar antecedentes hereditarios para cruces? (5)
  \item \textbf{(Abierta)} ¿Cómo evitar cruces irresponsables? \textit{Respuesta:}
  verificar antecedentes hereditarios y limitar el uso con fines de lucro.
  \item ¿La interfaz debe ser simple para personas sin experiencia técnica? (4)
  \item \textbf{(Abierta)} ¿Qué es vital antes de dar una mascota en adopción?
  \textit{Respuesta:} conocer el entorno del adoptante y asegurar comunicación
  constante.
\end{enumerate}

\textbf{Tabulación de resultados:} el 93\,\% de los ítems Likert obtuvieron
una valoración de 4 o 5, confirmando la alta necesidad del sistema
MundiPets. Los usuarios priorizan la privacidad de datos clínicos sensibles
sobre funciones de conveniencia como la geolocalización. Las respuestas
abiertas coinciden unánimemente en que el ``seguimiento post-adopción'' es
la funcionalidad más crítica para reducir el abandono animal.

\textbf{Resultados del cuestionario}

\noindent\textbf{Preguntas del cuestionario:}
\begin{itemize}[leftmargin=*, noitemsep]
	\item \textbf{P1:} ¿Es necesario un registro digital unificado de mascotas?
	\item \textbf{P2:} ¿El historial de vacunas debe ser de consulta obligatoria?
	\item \textbf{P3:} ¿Las notificaciones automáticas mejorarían el cumplimiento de citas?
	\item \textbf{P4:} ¿Es vital registrar el temperamento/raza para evaluar adopciones?
	\item \textbf{P5:} ¿La geolocalización de clínicas es útil para el usuario?
	\item \textbf{P6:} ¿Qué datos considera más sensibles en el perfil médico?
	\item \textbf{P7:} ¿Los datos de enfermedades catastróficas deben ser privados?
	\item \textbf{P8:} ¿Se debe incluir un sistema de seguimiento para adopciones?
	\item \textbf{P9:} ¿Es necesario registrar antecedentes hereditarios para cruces?
	\item \textbf{P10:} ¿Cómo evitar cruces irresponsables?
	\item \textbf{P11:} ¿La interfaz debe ser simple para personas sin experiencia técnica?
	\item \textbf{P12:} ¿Qué es vital antes de dar una mascota en adopción?
\end{itemize}
...
\hline
1  & Alta necesidad de registro unificado. & El módulo de registro es la base del sistema. \\
\hline
2  & Registro de vacunas es obligatorio. & Prioridad en la base de datos clínica. \\
\hline
3  & Notificaciones son muy valoradas. & Implementar sistema de alertas automáticas. \\
\hline
4  & Registro de temperamento clave en adopción. & Incluir campo de comportamiento en perfil. \\
\hline
5  & Geolocalización es útil pero secundaria. & Función opcional en fase de desarrollo. \\
\hline
6  & Alta demanda de privacidad de datos. & Implementar permisos de acceso (roles). \\
\hline
7  & Seguimiento de adopción es crítico. & Módulo de monitoreo post-adopción. \\
\hline
8  & Antecedentes hereditarios para cruces. & Módulo de gestión genética/genealogía. \\
\hline
9  & Interfaz amigable para todo usuario. & Diseño UX centrado en la simplicidad. \\
\hline
10 & Sensibilidad en enfermedades críticas. & Encriptar campos de diagnósticos graves. \\
\hline
11 & Control estricto de cruces. & Validación de perfiles para evitar lucro. \\
\hline
12 & Entorno es vital antes de adoptar. & Registro de condiciones del adoptante. \\
\hline
\end{tabularx}
\end{table}
...
\textbf{Fecha:} 17/05/2026 | \textbf{Duración:} 25 minutos |
\textbf{Participantes:} Todo el equipo de desarrollo.
...
\hline
\endhead
M-01 & RF-01 -- Registrar perfil de mascota & CU-01 & US-01 \\
\hline
M-01 & RF-02 -- Actualizar información de mascota & CU-01 & US-01 \\
\hline
M-02 & RF-03 -- Buscar mascotas & CU-02 & US-02 \\
\hline
M-02 & RF-04 -- Filtrar mascotas / compatibilidad & CU-02 & US-02 \\
\hline
M-03 & RF-05 -- Solicitar adopción/cruza & CU-03 & US-03 \\
\hline
M-03 & RF-06 -- Contactar propietario & CU-03 & US-03 \\
\hline
M-04 & RF-07 -- Validar historial médico & Validar información médica & US-04 \\
\hline
M-05 & RNF-SEG-01 -- Perfil verificado & Validar información médica & US-04 \\
\hline
M-03 & RF-08 -- Consultar solicitudes & Consultar solicitudes & US-05 \\
\hline
M-03 & RF-09 -- Gestionar solicitudes & Consultar solicitudes & US-05 \\
\hline
M-05 & RNF-01 -- Protección de datos médicos sensibles & CU-01, CU-03 & US-01, US-03 \\
\hline
M-02 & RNF-05 -- Tiempo de respuesta de búsqueda & CU-02 & US-02 \\
\hline
\end{longtable}
...
enfermedades catastróficas (RNF-01). El cuestionario, aplicado de forma
integrada a la entrevista, aportó una cuantificación de tendencias (por
ejemplo, el 93\,\% de valoraciones altas en los ítems Likert) que permitió
priorizar funcionalidades de manera más objetiva. La principal limitación
real fue la imposibilidad de aplicar un cuestionario digital independiente
a una muestra más amplia, dada la disponibilidad limitada de los
profesionales consultados, lo cual coincide con las advertencias de
IREB CPRE FL v3.1~\cite{ireb2023} sobre el costo en tiempo de la entrevista
y la necesidad de complementarla con técnicas de mayor alcance en
iteraciones futuras del PFC.
...
Tal como se documenta en la Sección~4.2, el cuestionario fue aplicado de
forma directa durante las entrevistas técnicas y no mediante un formulario
digital independiente (Google Forms), debido a la disponibilidad real de
los stakeholders consultados y a la naturaleza especializada de las
preguntas. Por esta razón, no existe un enlace de Google Forms ni
resultados exportados adicionales a los presentados en la
Tabla~\ref{tab:cuestionario} (Sección~4.2), la cual constituye la
tabulación completa de las respuestas obtenidas.
...
\hline
Claude (Anthropic) & Apoyo en la redacción y estructuración del fundamento
teórico, consolidación de la lista de requisitos crudos y únicos, y
generación de los diagramas i* 2.0 (SD/SR) y del diagrama de casos de uso a
partir de la información elicitada por el equipo. & 2, 5, 6, 7 \\
\hline
Zotero & Gestión y formateo de referencias bibliográficas en estilo IEEE. &
8 \\
\hline
\end{tabularx}
\end{table}
